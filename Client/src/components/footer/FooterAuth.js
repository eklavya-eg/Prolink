      ...
      <Text
        ...
        <Text as='span' fontWeight='500' ms='4px'>
          <Link
            ...
            color={textColor}
            target="_blank"
            href='https://prolinkinfotech.com/'> Prolink Infotech.</Link> Need help, facing issues, or looking for a new feature? Contact us for paid support and services at <Link href='mailto:egmm0120@gmail.com' fontWeight='500'
              color={textColor}
              target="_blank">egmm0120@gmail.com</Link>
        </Text>
      </Text>
      {/* <List display='flex'>
        <ListItem
